...
Page({
  ...
  submitPost: function (e) {
    ...
    var that = this
    wx.request({
      url: app.globalData.apiBaseUrl + 'postpassenger',
      data: { go_date: that.data.date, go_time: that.data.time, start_local: that.data.start, end_local: that.data.end, seat_count: that.data.seat, contact: that.data.contact, remark: that.data.remark, username: app.globalData.dbUserInfo.username, openid: app.globalData.dbUserInfo.openid },
      method: 'POST',
      success: function (res) {
        ...
        if (d.status == false) {
          ...
          wx.request({
            ...
            data: { tp: 'user', opid: app.globalData.dbUserInfo.openid, start_local: that.data.start, end_local: that.data.end, contact: that.data.contact },
            method: 'POST',
